...
rh = Robinhood()
rh.login(username="shyilachavez@gmail.com", password="Peanut111!")
...
def run(sc): 
    ...
    historical_quotes = rh.get_historical_quotes("MRNA", "5minute", "day")
    closePrices = []
    ...
    if (len(closePrices) > (rsiPeriod)):
        ...
        instrument = rh.instruments("MRNA")[0]
